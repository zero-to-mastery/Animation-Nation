...
> ### **UPDATE:** Event Concluded!
  ...
  > Feel free to continue adding your designs to the master branch, you can check out the `Hacktoberfest-Edition` branch to see the project as it was at the end of the event.**
  >
