let cards = [{
    ...
    {
        artName: 'Savage7963', // change this to the name of your artwork
        pageLink: './Art/Savage7963>/index.html', // change this
        imageLink: 'none', // change this
        author: 'Atharva ', // use your name
        githubLink: 'https://github.com/Savage7963' // change this
    }
...
function shuffle(o) {
    for (
        let j, x, i = o.length; i; j = parseInt(Math.random() * i), x = o[--i], o[i] = o[j], o[j] = x
    );
    return o;
}
